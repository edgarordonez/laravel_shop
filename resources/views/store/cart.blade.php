                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($cart as $product)
                            <tr>
                                ...
                                <td>{{ $product->name }}</td>
                                <td>
                                    <input id="product_{{ $product->id }}" class="input-mini" type="number" min="1"
                                           max="10" value="{{ $product->quantity }}">
                                    <a href="javascript::void(0)" class="btn btn-default btn-update-item"
                                       data-href="{{ route('cart-update', $product->slug) }}"
                                       data-id="{{ $product->id }}">
                                        <i class="fa fa-refresh"></i>
                                    </a>
                                </td>
                                <td id="price_quantity_{{ $product->id }}" data-price_quantity="{{ $product->price }}">{{ money_format('%.2n', $product->price) }}€</td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td><strong id="price_total_table">{{ money_format('%.2n', $currentTotalCart) }}€</strong>
                            </td>
                        </tr>
                        </tbody>
                    </table>
